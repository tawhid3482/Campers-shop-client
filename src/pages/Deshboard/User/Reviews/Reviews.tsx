...
const Reviews = () => {
    ...
    const handleSubmit = (values: any) => {
        setSubmitting(true);
        console.log('User Review:', values);
        setTimeout(() => {
            form.resetFields();
            setSubmitting(false);
    ...
    return (
        <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto' }}>
            ...
            <Form
                ...
                style={{ background: '#fff', padding: '20px', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}
            >
                <Form.Item
                    name="name"
                    label="Your Name"
                ...
                <Form.Item>
                    <Button className="bg-[#832b38]" htmlType="submit" loading={submitting} block>
                        Submit Review
                    </Button>
                </Form.Item>
            </Form>
