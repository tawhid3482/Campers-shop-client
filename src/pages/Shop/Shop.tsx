...
const Shop = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      {/* Desktop Sidebar */}
      <aside className="w-72 bg-white shadow-lg border-r p-6 hidden md:block overflow-y-auto h-screen sticky top-0">
        <SidebarContent
          search={search}
          setSearch={setSearch}
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 flex">
          ...
          ></div>
          <div className="fixed left-0 top-0 w-72 h-screen bg-white p-6 z-50 shadow-lg overflow-y-auto">
                ...
                return (
                  ...
                  >
                    ...
                    <CardContent className="p-4">
                      ...
                      <p className="text-[#833d47] font-bold mb-2">
                        ${product.price}
                      </p>
                      <Link
                        to={`/products/${product._id}`}
                        className="block text-center bg-[#833d47] hover:bg-[#6c8e1e] text-white py-2 rounded-md font-semibold"
                      >
                        View Details
                      </Link>
                    </CardContent>
